            ...
            <div className="flex-1 space-y-8">
              ...
              <AnimatedSection immediate delay={0.1}>
                <h1 className="text-4xl md:text-5xl font-bold leading-[1.1] tracking-tight">
                  Virtualize your expertise once. Train, certify, and resell it{" "}
                  <span className="text-gradient-peach-purple whitespace-nowrap">n times</span>.
                </h1>
              </AnimatedSection>

              <AnimatedSection immediate delay={0.2}>
                <p className="text-xl text-white/60 max-w-xl leading-relaxed">
                  We co-design and virtualize your micro-credentials, produce the content, measure impact with learning analytics, and issue POK-verified credentials. One partner, end to end. Clear, measurable ROI for your talent, your corporate clients, and your students.
                </p>
              </AnimatedSection>
              ...
              <AnimatedSection immediate delay={0.25}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 py-2 max-w-xl">
                  {[
                    "Live in 6–12 weeks",
                    "Recurring revenue, cohort after cohort",
