...
export const metadata: Metadata = {
  title: "Rapid Studio",
  description:
    "Rapid Studio is merahki.ai's AI-native e-learning authoring environment — the Enterprise Authoring tool Built for Speed that replaces the 'course-catalog' model with a dynamic, four-pillar performance ecosystem. Using Liquid Content technology (24-hour updates), the Merahki AI Creator Agent converts SOPs, manuals, and release notes into structured training in minutes via Autonomous Course Synthesis. The Merahki AI Manager Agent automates compliance tracking and workforce certification paths via natural language commands. The result: Workforce Readiness at scale, Employee Certification Paths with Kirkpatrick Level 4 ROI, and Just-in-Time Learning delivered in the flow of work — ISO 27001 and SOC 2 compliant.",
  keywords: [
    "Rapid Studio",
    "Enterprise Authoring Built for Speed",
    "Liquid Content 24-hour updates",
  ...
  openGraph: {
    title: "Rapid Studio — AI-Native e-Learning Authoring | merahki.ai",
    description:
      "What are the best AI tools for course creation? Rapid Studio by merahki.ai. Liquid Content updates training in 24 hours, the Creator Agent turns release notes into courses via Autonomous Course Synthesis, and the Manager Agent automates Employee Certification Paths — Kirkpatrick Level 4 ROI built in.",
