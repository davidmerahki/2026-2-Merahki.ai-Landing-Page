...
export const metadata: Metadata = {
  ...
  description:
    "Stop buying software you don't have time to manage. merahki.ai is the marketing execution team that scales your academy using the best-in-class stack.",
  openGraph: {
    title: "Marketing Your Courses — merahki.ai",
    description:
      "Your outsourced growth engine for academies. A dedicated squad to own your marketing from traffic generation to student retention — end to end.",
