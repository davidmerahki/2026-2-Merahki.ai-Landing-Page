...
export const homeCopy = {
  es: {
    ...
    personalization: {
      ...
      engineDesc: "Lee la metadata de cada ficha y arma la ruta exacta para cada perfil.",
      criteria: ["Rol objetivo", "Industria", "Empresa destino", "Interés"],
      profilesLabel: "Toca un perfil para ver su ruta",
      profiles: [
        { name: "Valentina", role: "Analista de datos · Salud", route: ["B", "F", "K", "C"] },
        { name: "Andrés", role: "Product manager · Fintech", route: ["A", "I", "G"] },
        { name: "María José", role: "Consultora · Gobierno", route: ["E", "J", "D", "H"] },
      ],
  ...
  en: {
    ...
    personalization: {
      ...
      engineDesc: "Reads each module's metadata and assembles the exact path for every profile.",
      criteria: ["Target role", "Industry", "Destination company", "Interest"],
      profilesLabel: "Tap a profile to see its path",
      profiles: [
        { name: "Valentina", role: "Data analyst · Healthcare", route: ["B", "F", "K", "C"] },
        { name: "Andrés", role: "Product manager · Fintech", route: ["A", "I", "G"] },
        { name: "María José", role: "Consultant · Government", route: ["E", "J", "D", "H"] },
      ],
